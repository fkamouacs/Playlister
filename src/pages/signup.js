      ...
      {!isLoggedIn ? (
        <div className="flex flex-row justify-center ">
          <div>
            ...
            <div className="login-container p-4 mt-[16px] flex flex-row justify-center text-center border-[rgba(219,219,219)] border-[1px] px-2">
              <p className=" pr-1">Have an account?</p>
              <Link className="text-[#C26566] text font-medium" href="/login">
                Log in
              </Link>
            </div>
          </div>
